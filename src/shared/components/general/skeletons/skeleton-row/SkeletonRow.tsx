...
type SkeletonRowListProps = { count?: number; skeletonHeight?: number };

export function SkeletonRowList({ count = 5, skeletonHeight = 32 }: SkeletonRowListProps) {
  return (
    <View>
      {Array.from({ length: count }, (_, index) => (
        ...
        >
          <View className="flex-1 flex-row items-center gap-3" style={{ minWidth: 0 }}>
            <Skeleton variant="rounded" style={{ width: 36, height: skeletonHeight }} />
